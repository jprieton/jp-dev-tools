 ...
 */
$labels  = array(
    'name'                       => __( 'Portfolio Categories', JPDEVTOOLS_TEXTDOMAIN ),
    'singular_name'              => __( 'Portfolio Category', JPDEVTOOLS_TEXTDOMAIN ),
    'menu_name'                  => __( 'Categories', JPDEVTOOLS_TEXTDOMAIN ),
    'all_items'                  => __( 'All Portfolio Categories', JPDEVTOOLS_TEXTDOMAIN ),
    'parent_item'                => __( 'Parent Portfolio Categories', JPDEVTOOLS_TEXTDOMAIN ),
    'parent_item_colon'          => __( 'Parent Portfolio Categories:', JPDEVTOOLS_TEXTDOMAIN ),
    'new_item_name'              => __( 'New Portfolio Categories Name', JPDEVTOOLS_TEXTDOMAIN ),
    'add_new_item'               => __( 'Add New Item', JPDEVTOOLS_TEXTDOMAIN ),
    'edit_item'                  => __( 'Edit Portfolio Categories', JPDEVTOOLS_TEXTDOMAIN ),
    'update_item'                => __( 'Update Portfolio Categories', JPDEVTOOLS_TEXTDOMAIN ),
    ...
    'search_items'               => __( 'Search Portfolio Categories', JPDEVTOOLS_TEXTDOMAIN ),
...
$rewrite = array(
    'slug'         => _x( 'portfolio-category', 'taxonomy slug', JPDEVTOOLS_TEXTDOMAIN ),
    'with_front'   => false,
    'hierarchical' => true,
);
$args    = array(
